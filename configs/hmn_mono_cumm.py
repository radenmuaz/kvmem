hp = dict(
    ...
    name='hmn_mono_cumm', seed=42,

    curriculum=[
        # Ablation 3: cum_mean only — global pressure, no pairwise ReLU.
        # loss = ntp + adaptive_cum * ReLU(mean_t(cum_mean_t) - mean(nll_t))
        dict(
            ...
            joint_mix=[
                dict(
                    ...
                    h_loss_w=0.0,
                    mono_w=0.0, mono_margin=0.0, cum_w=1.0,
                ),
            ],
