hp = dict(
    ...
    name='hmn_mono_p4', seed=42,

    curriculum=[
        # src_period=4: src visible at turns t=0,4,8,...; blind at t=1,2,3,5,6,7,...
        # 3 consecutive blind turns per review — stronger bottleneck than p=2.
        dict(
