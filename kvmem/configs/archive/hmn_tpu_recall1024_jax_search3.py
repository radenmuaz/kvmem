...
`hmn_tpu_recall1024_jax_search3.py` — ONE of a 4-trial random hyperparameter
...
This trial: lr_max=4.0300e-05  adapt_temp=1.1800  warmup_steps=2000

Run (never two jobs at once):
    python3 -m kvmem.hmn_jax --config kvmem/configs/hmn_tpu_recall1024_jax_search3.py
"""

from kvmem.hmn_jax import load_config

hp = load_config('kvmem/configs/hmn_tpu_recall1024_jax_adaptive_mix.py')
hp['name'] = 'hmn_tpu_recall1024_jax_search3'
hp['lr_max'] = 4.03e-05
hp['adapt_temp'] = 1.18
