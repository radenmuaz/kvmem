...
`hmn_tpu_recall1024_jax_search0.py` — ONE of a 4-trial random hyperparameter
...
This trial: lr_max=1.7800e-04  adapt_temp=1.1600  warmup_steps=1000

Run (never two jobs at once):
    python3 -m kvmem.hmn_jax --config kvmem/configs/hmn_tpu_recall1024_jax_search0.py
"""

from kvmem.hmn_jax import load_config

hp = load_config('kvmem/configs/hmn_tpu_recall1024_jax_adaptive_mix.py')
hp['name'] = 'hmn_tpu_recall1024_jax_search0'
hp['lr_max'] = 0.000178
hp['adapt_temp'] = 1.16
