"""
Architecture ablation: no RoPE (rope=False, yarn=False). Fixed 2-stage testbed.
Tests whether position encoding helps or hurts in this slot-bottleneck regime.
"""
...
hp = dict(
    ...
    log_every=200,
    rope=False, yarn=False, null_kv=True, compile=False,
    chunk_attn=256,
    name='hmn_chunk_abl2_norope', seed=42,
