hp = dict(
    ...
    name='hmn_mono_tlogit_fixed', seed=42,

    curriculum=[
        # Ablation 1 (teacher logit): fixed alpha=0.5 for all refinement turns k>=1.
        # Turn 0 always alpha=0 (pure GT). k_choices=[1..4], eval k=0..12 for extrapolation.
        dict(
            ...
            joint_mix=[
                dict(
                    ...
                    teacher_iters=10,
                    teacher_lr=1e-3,
                    teacher_alpha=0.5,          # fixed — no schedule
                ),
            ],
