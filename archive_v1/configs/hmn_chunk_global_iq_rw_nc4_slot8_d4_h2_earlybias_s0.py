"""
Head count ablation — depth=4, d=64, n_heads=2 (dh=32).
...
hp = dict(
    train_fn='fb',
    d=64, n_layers=4, n_heads=2, d_ff=256, V=268,
    ...
    name='hmn_chunk_global_iq_rw_nc4_slot8_d4_h2_earlybias_s0', seed=42,
