"""
Head count ablation — depth=4, d=64, n_heads=4 (dh=16).
Distribution: arcsine (Beta(0.5,0.5)) warmup_x — equalizes byte coverage,
upweights X=0 (Win A) and X=32 (Win C) endpoints.

dh=16, baseline head count

Baseline for this ablation: d4_h4_earlybias_s0 (n_heads=4).
...
hp = dict(
    ...
    name='hmn_chunk_global_iq_rw_nc4_slot8_d4_h4_earlybias_s0', seed=42,
